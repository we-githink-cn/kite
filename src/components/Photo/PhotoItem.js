...
import {Icon, Modal, Header, Image, Button, Comment, Dropdown, Item, Sidebar, Label} from 'semantic-ui-react';
...
export default class PhotoItem extends PureComponent {
  ...
  handleCommentClick =()=>{
    ...
    scrollToAnchor('detail-comment-content');
  };

  handleModalCommentClick =()=>{
    this.setState({
      modalComment: true,
    },()=>{
      const commentVditor = this._initCommentEditor({
  ...
  render() {
    ...
    return (
      <div className={`${styles.PhotoItemContent}`}>
        ...
        <div className={styles.PhotoItemImageContent} onClick={this.handleImagePreviewItemClick}>
          <img src={src}  alt=""/>
        ...
        <div className={styles.PhotoItemActionContent}>
          ...
          <div className={styles.PhotoItemActionItem} onClick={this.handleModalCommentClick}>
        ...
        <div className={styles.PhotoItemIconText} onClick={this.handleOpenDetail}>
          4,117 次赞
        </div>
        <div onClick={this.handleOpenDetail} className={`${styles.PhotoItemText} vditor-reset`} dangerouslySetInnerHTML={{ __html: '<p>Kotlin 是一个用于现代多平台应用的静态编程语言，由 JetBrains 开发。Kotlin可以编译成Java字节码，也可以编译成JavaScript，方便在没有JVM的设备上运行。Kotlin已正式成为Android官方支持开发语言。此外，Kotlin还是一门融合了面向对象与函数式编程的语言，支持泛型、安全的空判断，并且Kotlin与Java可以做到完全的交互。</p>' }}/>
        ...
        {/*图片预览*/}
        <Modal open={open} basic className={`${styles.ImagePreview} image-preview`} onClose={()=>{this.setState({open:false,isItem:true})}} style={isItem ? {} : {marginTop: '8rem'}}>
          ...
          <div className={styles.ImagePreviewActionWrapper}>
            <div className={styles.ImagePreviewActionItem} onClick={this.handleModalCommentClick}>
        ...
        {/*详情*/}
        <Modal className='article-detail' open={detailVisible} closeIcon onClose={() => { this.setState({ detailVisible: false }); }} style={{ width: '642px', borderRadius: '8px', marginTop: '4rem', marginBottom: '4rem' }}>
          <Sidebar.Pushable as="div">
            <Sidebar.Pusher>
              <Modal.Content className={styles.DetailWrapper}>
                  ...
                  <div className={styles.DetailContent}>
                    <div className={styles.DetailHeaderWrapper}>
                      ...
                      <div className={styles.DetailHeaderAction}>
                        ...
                        <Dropdown trigger={<Icon name='angle down' size='large'/>} pointing='top right' icon={null} >
                          <Dropdown.Menu>
                    ...
                    <div className={styles.DetailImageContent} onClick={this.handleImagePreviewClick}>
              ...
              <Sidebar as="div" animation="scale down" direction="bottom" visible={commentVisible}>
        ...
        {/*Item评论*/}
        <Modal size='small' open={modalComment} closeIcon onClose={()=>{this.setState({modalComment:false})}}>
          <Modal.Header style={{textAlign: 'center'}}>回复@会飞的贾斯汀</Modal.Header>
          <Modal.Content>
            <Item.Group>
              <Item>
                <div className='ui tiny image'>
                  <img style={{borderRadius: '50%',width: '80px', height: '80px'}} src="https://react.semantic-ui.com/images/avatar/large/justen.jpg" alt=""/>
                </div>
                <Item.Content>
                  <Item.Header as='a'>会飞的贾斯汀</Item.Header>
                  <Item.Meta>2019-4-23 22:30</Item.Meta>
                  <Item.Description>
          ...
          <div className={styles.ReplyVditorContent} style={{backgroundColor:'#F5F8FA'}}>
            <div className={styles.ReplyVditorHeader}>
              <div className={styles.ReplyVditorHeaderTitle}>
                <Icon name="share" style={{ marginRight: '8px' }} />
                <Label as="a" image>
