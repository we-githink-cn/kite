    ...
    const RightChatItem =(chat)=> (
      <div>
        ...
        <div className={`${styles.message} ${styles.otherMessage} ${styles.floatRight}`}>
          {
            checkStr(chat.message,'data:image') ? (<img onClick={this.handleImgClick.bind(this,chat.message)} src={chat.message} alt="" style={{width:'100%'}}/>): checkStr(chat.message,'.mp4') ? (<Embed
