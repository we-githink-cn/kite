...
export default class Index extends Component {
  ...
  render() {
    const {putVisible, previewVisible, previewImage, fileList, currentTags} =this.state;
    const uploadButton = (
      <div>
        <Ant.Icon type="plus" />
    ...
    return(
      <div className={styles.PhotoWrapper}>
        ...
        <Modal size='small' open={putVisible} closeIcon onClose={()=>{this.setState({putVisible: false})}}>
          <Modal.Content>
            ...
            <Modal open={previewVisible} closeIcon onClose={()=>{this.setState({previewVisible: false})}}>
              <Modal.Content image>
