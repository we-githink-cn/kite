  ...
  handleAddMessage = () => {
    ...
    setTimeout(() => {
      let item = {
        ...
        time: getCurrentTime(),
        message:
          '北京时间4月24日晚间，拼多多发布2018财年年报，披露该财年完整运营数据。2018年，' +
        ...
        <div className="ui equal width left aligned padded grid stackable">
          <div className="stretched row">
            <div className="sixteen wide tablet three wide computer column">
              <div className="ui segments">
                <div className="ui segment">
                  <h5 className="ui header">People List</h5>
                </div>
            ...
            <div className="sixteen wide tablet thirteen wide computer column">
              <div className="ui segments">
                <div className="ui segment">
                  <h5 className="ui header">Chat</h5>
                </div>
                <div className="ui segment">
                  <div className={styles.chat}>
                    ...
                    <div className={`${styles.chatMessage} clearfix`}>
                      <TextArea
                        onInput={this.handleChangeMessage}
                      ...
                      <Popup
                        trigger={
                          <div className={styles.FileBtn}>{emojify(':smile:', options)}</div>
                        }
                        on="hover"
                        hoverable
                      >
